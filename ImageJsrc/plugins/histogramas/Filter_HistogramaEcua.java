...
public class Filter_HistogramaEcua implements PlugInFilter {
    ImagePlus imp;
    ...
    public void run(ImageProcessor ip) {
        ...
        for (int y = 0; y < height; y++) {
            for (int x = 0; x < width; x++) {
                ...
                double newPixel = (rmax - rmin) * q + rmin + 0.5;
    ...
    private void showInterface() {
        ...
        int result = JOptionPane.showConfirmDialog(null, panel, "Parámetros de transformación discreta", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
